...
```{r wallpapeR_solution, fig.width=6, fig.height=5}
set.seed(9) #<<
par(bg = NA, mar = c(0,0,0,0)) # will take the whole screen
x = 1:70; y = 1:70 # make variables 
x.val = (x^2);   y.val = y
...
polygon(x = c(1,150,150,1),y = c(0,0,1,1), col = scales::alpha("blue",.5), border =  scales::alpha("green",.5))

plot(p.lo, type="l", ylab="p",    xlab="Ln odds", lwd=3); abline(h=.5, v=0, lty=3)
polygon(x = c(-10,0,0,-10),y = c(0,0,1,1), col = scales::alpha("red",.5), border =  scales::alpha("red",.5))
polygon(x = c(0,10,10,0),y = c(0,0,1,1), col = scales::alpha("blue",.5), border =  scales::alpha("green",.5))
```
...
```{r happy_birthday, echo=c(-1), eval=FALSE}
...
- Banks. 1998. H&book of simulation.
...
.pull-right[
- Jones, Maillardet, & Robinson. 2014. Introduction to scientific programming & simulation using R. 2ed.
