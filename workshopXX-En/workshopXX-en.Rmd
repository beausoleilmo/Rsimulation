...
- Some sloppy mathematical notation is  used. It'd help to be more rigorous if you could provide ways to write the notation better. 
- Not all the code is shown in the presentation to reproduce the examples. You have to go in the [presentation RMarkdown files](https://github.com/beausoleilmo/Rsimulation/blob/6786d553e657db08ae28a31c5a4764dade704400/workshopXX-En/workshopXX-en.Rmd) or the script file [Workshop R script](https://github.com/beausoleilmo/Rsimulation/blob/6786d553e657db08ae28a31c5a4764dade704400/workshopXX-En/scripts/workshopXX-en.r), which requires the [0.0_initialize.R](https://github.com/beausoleilmo/Rsimulation/blob/6786d553e657db08ae28a31c5a4764dade704400/workshopXX-En/scripts/0.0_initialize.R) and other scripts specified within. Don't forget to change the paths associated with some files to load everything. 
...
[Source here](https://williambiersack.weebly.com/math-jokes.html)  Explanation: This is a reference to a converging infinite series. The limit of this: from n=1 to infinity is the sum (1/2n) = 1 + 1/2 + 1/4 + 1/8 + ...  = 1 
...
- I added a cool function in R for Probability of coincidences called `pbirthday`
