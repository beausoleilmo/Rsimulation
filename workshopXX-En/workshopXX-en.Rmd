...
```{r linear_no_error, echo=-1, fig.width=8, fig.height=5}
...
```{r normal_dist_area, echo=-1, fig.width=9,fig.height=6}
...
par(mar=c(4,4,2,2), cex = 1.3)

set.seed(12345678)
lm.sim.fun <- function(n = 100, mean = 10, sd = 1, sd.err = 1, beta0 = 2.5, beta1 = 0.8, plot = FALSE) {
