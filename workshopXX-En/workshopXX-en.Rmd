...
.pull-left[
```{r prob_scale_zero_one, echo=FALSE, fig.width=4.7,fig.height=2}
par(mar = c(0,0,0,0), 
    # mfrow=c(1,2),
    cex = 1.2)
# Probability
...
.tiny[
Book
- Crawley, M.J., 2013. The R book 2nd ed., United Kingdom: John Wiley & Sons, Ltd. (see chapter 7)
- Otto, S.P. & Day, T., 2007. A Biologist's Guide to Mathematical Modeling in Ecology and Evolution. pp.1–973.
- Whitlock, M. C., & Schluter, D., 2020. The analysis of biological data. Third edition. Macmillan Learning, Austin.
