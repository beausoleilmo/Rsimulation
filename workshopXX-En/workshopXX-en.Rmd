...
mean.log # This is the mean that we would find on the log scale for the log(raw.num)
2^mean.log
...
# Now compare the geometric mean of the raw numbers with the mean of the log which was transformed baed into the raw number scale 
gm
2^mean.log
```
