...
- **What is a model?** Can you give examples of models that are not statistical models? 
  ...
  * examples such as 
    ...
    - The atomic model 
    - Basically our task is to take a **statistical Clay and model it** as we wish based on some idea. "Pâte à modelée" (Plasticine, Play-Doh)
...
???
Some examples 
- Ecological and Climate Model
- Modelling biological systems (e.g., epidemiology)
- Statistical model
- Simulations (see [Modeling and simulation](https://en.wikipedia.org/wiki/Modeling_and_simulation))
- Etc. 
...
- Note that a **"parameter"** is a quantity that is CONSTANT. 
