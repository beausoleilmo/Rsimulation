...
image(x = x, y = x, z = x.mul, axes = FALSE, main ='Multiplication', xlab = "")
title(xlab = "x", line=2, cex.lab=1.2)
axis(1, at = seq(1, max(x), by = 1))
axis(2, at = seq(1, max(x), by = 1))
add.lab(x,x.mul, cex=cex)

image(x = x, y = x, z =x.sub, axes = FALSE, main ='Subtraction', xlab = "")
title(xlab = "x", line=2, cex.lab=1.2)
axis(1, at = seq(1, max(x), by = 1))
axis(2, at = seq(1, max(x), by = 1))
add.lab(x,x.sub, cex=cex)

image(x = x, y = x, z =x.add, axes = FALSE, main ='Addition', xlab = "")
title(xlab = "x", line=2, cex.lab=1.2)
axis(1, at = seq(1, max(x), by = 1))
axis(2, at = seq(1, max(x), by = 1))
add.lab(x,x.add, cex=cex)

image(x = x, y = x, z =x.div, axes = FALSE, main ='Division', xlab = "")
title(xlab = "x", line=2, cex.lab=1.2)
axis(1, at = seq(1, max(x), by = 1))
axis(2, at = seq(1, max(x), by = 1))
...
```{r wallpapeR_solution, fig.width=6, fig.height=3.5}
set.seed(9) #<<
par(bg = NA, mar = c(0,0,0,0)) # will take the whole screen
x = 1:70; y = 1:70 # make variables 
x.val = (x^2);   y.val = y
