...
hypothesis.testing <- function(mean.pop=2, prob = .05, sd = 1, n=NULL) {
...
dval=dnorm(x, mean = mean, sd = sd)

curve(dnorm(x, mean = mean, sd = sd),-6,10, n = 10000,xlim = c(-5, 7), 
      ylim = range(0,1,max(dval)),
      xlab = "", lwd =3 )
...
null.test =qnorm(p = p, mean = mean, sd=sd,lower.tail = F)
abline(v = null.test)
